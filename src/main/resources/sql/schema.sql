...
CREATE TABLE `users` (
    ...
    `point_tsid`	varchar(255) not null,
...
CREATE TABLE `seats` (
	...
	`concert_tsid`    varchar(255) not null,
...
CREATE TABLE `reservations` (
	...
	`user_tsid`	varchar(255) not null,
    `concert_tsid`	varchar(255) not null,
	`seat_tsid`	varchar(255) not null,
